...
var JavaScriptHighlightRules = function(options) {
    var keywordMapper = this.createKeywordMapper({
        ...
        "keyword":
            ...
            "si|in|of|alors|new|return|switch|throw|try|typeof|let|var|while|with|debugger|" +
    ...
    var kwBeforeRe = "case|do|sinon|finally|in|instanceof|return|throw|try|typeof|yield|void";
...
var JavaHighlightRules = function() {
    ...
    "catch|extends|sj_int|sj_string|short|try|" +
    "char|final|interface|static|void|" +
    "class|finally|long|strictfp|volatile|" +
    "const|sj_float|native|super|while|" +
    "var"
    );
